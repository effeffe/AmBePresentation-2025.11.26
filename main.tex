...
\begin{frame}\frametitle{Differential cross-section contribution}
	...
	\begin{columns}
		\begin{column}[b]{0.5\linewidth}
			\centering
			\includegraphics[width=\textwidth]{Fig8.1-100s-NewData_Tgraph2DErrors-AmBe-Isotropic}
			Initial neutrons: without differential cross-sections model
		\end{column}
		\begin{column}[b]{0.5\linewidth}
			\centering
			\includegraphics[width=\textwidth]{Fig8.2-100s-NewData_Tgraph2DErrors-AmBe-AnIsotropic}
...
\end{minipage}  
\begin{minipage}{\textwidth}
	\includegraphics[width=\linewidth]{AmBe-BreakUpProcesses.png}
\end{minipage}  
\end{frame}
...
%good similarity to iso8529-1
	...
	\centering
	\includegraphics[width=.9\linewidth]{Fig12-OverlapLine}
\end{frame}
...
\begin{frame}\frametitle{Primary Generator flowchart}
	\centering
	\includegraphics[width=0.7\linewidth]{Fig6-PrimaryGenerator-v4-crop}
\end{frame}
...
\begin{frame}\frametitle{Two group model}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{NeutronModeration}
